...
class Juego 
{
  ...
  /**
   * Evento de atencion a la pulsacion del teclado
   * Cuando se pulsa cualquier letra se revisara cada palabra y validarla
   * @param {KeyboardEvent} evento Evento de pulsacion de teclado
   */
  pulsar(evento)
  {
